    ...
    <section id="system" className="max-w-7xl mx-auto px-6 py-20 border-t border-border/50">
      <div className="text-center mb-16">
        <h2 className="text-3xl font-mono font-bold text-foreground mb-4">
          System <span className="text-accent">Requirements</span>
        </h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        {requirements.map((req, i) => (
          <motion.div
            ...
            className="p-6 rounded-xl bg-muted/20 border border-border flex flex-col items-center text-center group hover:border-accent/30 transition-colors"
          >
            <req.icon className="w-10 h-10 text-accent mb-4 group-hover:scale-110 transition-transform" />
